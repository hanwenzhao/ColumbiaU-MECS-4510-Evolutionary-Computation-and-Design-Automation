...
% GP1(operator, varConst, maxLevel, trainingData, validationData, 200, 1000, 1, 'false', 'none');
GP2(operator, varConst, maxLevel, trainingData, 200, 10, 1, 'true');
